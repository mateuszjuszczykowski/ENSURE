...
namespace DATABASE_library.Migrations
{
    ...
    [Migration("20240806154006_AddDeviceIDtoMeasurement")]
    partial class AddDeviceIDtoMeasurement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DATABASE_library.DataModel", b =>
                {
            ...
            modelBuilder.Entity("DATABASE_library.MeasurementModel", b =>
                {
                    b.Property<string>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DATABASE_library.RawDataModel", b =>
                {
                    b.Property<string>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DATABASE_library.DataModel", b =>
                {
                    b.HasOne("DATABASE_library.MeasurementModel", "Measurement")
                        .WithMany("Data")
            ...
            modelBuilder.Entity("DATABASE_library.RawDataModel", b =>
                {
                    b.OwnsOne("DATABASE_library.Payload", "Payload", b1 =>
                        {
                            ...
                            b1.OwnsOne("DATABASE_library.Energy", "ENERGY", b2 =>
                                {
